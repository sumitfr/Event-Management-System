    ...
    content: [
        {
            table: {
                ...
                body: [
                    [
                        { text: 'DreamFest', fontSize: 20, bold: true, margin: [10, 0, 0, 0], color: '#888888' },
                        { text: 'INVOICE', fontSize: 16, bold: true, alignment: 'right', margin: [0, 0, 10, 0], color: '#888888' }
                    ],
                    [
                        { text: 'Sohan', fontSize: 18, bold: true, margin: [10, 0, 0, 0] },
        ...
        { text: accountNumberCheckbox.checked ? (accountNumberCheckbox.checked ? accountNumber.value : '') : '', fontSize: 10, ...regularStyle, margin: valueMargin },
        {
            columns: [
                [
                    ...
                    { text: billTocompanyName ? 'DreamFest:' : '', fontSize: 10, bold: true, margin: [10, 1, 0, 0], color: '#888888' },
